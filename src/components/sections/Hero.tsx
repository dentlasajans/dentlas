...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center px-6 overflow-hidden pt-32 pb-24 md:py-0">
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="relative w-full h-full flex items-center justify-center overflow-hidden scale-110 md:scale-125" style={{ perspective: 1200 }}>
            ...
            {/* Glowing sphere base */}
            <div className="absolute w-40 h-40 md:w-64 md:h-64 bg-brand/30 rounded-full blur-2xl z-0" />
            ...
            <div className="absolute w-64 h-64 md:w-[400px] md:h-[400px] border border-white/5 rounded-[2rem] z-10 bg-white/[0.01] rotate-12" />

            {/* Floating Layer/Canvas 2 (Bezier visualization) */}
            <div className="absolute w-48 h-48 md:w-[300px] md:h-[300px] border border-brand/30 rounded-2xl z-20 hidden md:flex items-center justify-center bg-brand/[0.01] -rotate-6">
            ...
            <div className="absolute w-56 h-56 md:w-[350px] md:h-[350px] border border-white/10 rounded-full z-15 border-dashed border-[1.5px] hidden lg:block rotate-45" />
            ...
            <div className="absolute inset-0 flex items-center justify-center z-0 pointer-events-none hidden md:flex">
               <div className="absolute -mt-20 -ml-20 w-16 h-16 md:w-24 md:h-24 rounded-full bg-[#00FFFF] mix-blend-screen blur-[24px] opacity-30" />
               <div className="absolute mt-10 ml-24 w-12 h-12 md:w-20 md:h-20 rounded-full bg-[#FF00FF] mix-blend-screen blur-[20px] opacity-30" />
               <div className="absolute mt-24 -ml-12 w-14 h-14 md:w-24 md:h-24 rounded-full bg-[#FFFF00] mix-blend-screen blur-[20px] opacity-40" />
            </div>
            ...
            <div className="absolute z-40 transform -rotate-12 hidden md:block translate-y-[-20px] translate-x-[20px]">
      ...
      <div 
        className="absolute bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 text-white/80 flex flex-col items-center gap-2 animate-bounce"
      >
