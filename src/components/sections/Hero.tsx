...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-[100dvh] flex items-center overflow-hidden pt-32 pb-24 md:py-0">
      <div className="max-w-7xl mx-auto w-full px-6 grid md:grid-cols-2 gap-12 items-center">
        <div className="flex flex-col items-start md:items-start text-left">
          ...
          <div className="w-full h-0 mt-12 md:mt-16">
            <motion.div 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.5 }}
              className="absolute left-0 w-full bg-white/5 border-y border-white/10 py-6 md:py-8 flex z-0"
            >
              <div className="flex w-[200%] animate-marquee items-center gap-4">
                {[...Array(2)].map((_, i) => (
                  <div key={i} className="flex-1 flex justify-around items-center text-xs sm:text-sm lg:text-base font-black uppercase tracking-[0.3em] text-white/50 whitespace-nowrap min-w-max">
                     <span className="mx-8">STRATEJİ</span>
                     <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0 opacity-50"></span>
                     <span className="mx-8">TASARIM</span>
                     <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0 opacity-50"></span>
                     <span className="mx-8">SOSYAL MEDYA</span>
                     <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0 opacity-50"></span>
                     <span className="mx-8">REKLAM</span>
                     <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0 opacity-50"></span>
                     <span className="mx-8">KREATİF</span>
                     <span className="w-1.5 h-1.5 rounded-full bg-brand shrink-0 opacity-50"></span>
                  </div>
                ))}
              </div>
          ...
          <div className="w-full h-[72px] md:h-[88px] mt-12 md:mt-16" />
        </div>
